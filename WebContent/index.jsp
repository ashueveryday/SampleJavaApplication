...
<head>
<meta charset="utf-8">
<title> Sample Java-MySql Application</title>
...
<body>
	<div class="App42PaaS_header_wrapper">
		<div class="App42PaaS_header_inner">
			<div class="App42PaaS_header">
				<div class="logo">
					<a href="http://www.hcl.com/"><img alt="HCL" src="images/nova.png"></img></a>
				</div>
			</div>
		</div>
	</div>
	...
	<div class="App42PaaS_body_wrapper">
		<div class="App42PaaS_body">
			<div class="App42PaaS_body_inner">
				<div class="contactPage_title"> SAMPLE APPLICATION FORM</div>
					...
					<form method="post" action="save">
						<fieldset>
							...
							<div class="contactForm_tr">
								...
								<div class="contactForm_td2"
									style="color: red; padding-left: 90px; display: none;"
									id="emailErr">Enter Your personal Email ID</div>
							</div>
  ...
  <!--------------------------------------------------------------------------------------------------------------------------------->
				...
				<br></br>
						...
						<div class="reachusLink">
							<a href="mailto:support@hcl.com">support@hcl.com</a>
						</div>
					</div>
				</div>

				<div class="reachus_wrapper_vcard">
					<div class="vcard_txt">HCL Technologies, India</div>
				</div>
			</div>
		</div>
	</div>
